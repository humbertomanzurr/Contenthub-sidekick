    ...
    <div style={{minHeight:"100vh",background:"#FFFFFF",fontFamily:"system-ui,sans-serif"}}>
      ...
      <div style={{padding:"80px 32px 60px",textAlign:"center",maxWidth:700,margin:"0 auto"}}>
        <div style={{display:"inline-flex",alignItems:"center",gap:8,fontSize:11,padding:"5px 14px",borderRadius:20,border:"0.5px solid #E8E8E8",color:"#555",marginBottom:28,background:"#FAFAFA"}}>
          ...
          Built for the content renaissance
        </div>
        ...
        <div style={{fontSize:15,color:"#555",lineHeight:1.7,maxWidth:480,margin:"0 auto 32px"}}>
          Plan campaigns, organize your pipeline, and track what actually resonates — so you can focus on making content that no algorithm could generate.
        </div>
      ...
      <div style={{maxWidth:640,margin:"0 auto",padding:"0 32px 48px"}}>
        <div style={{padding:"28px 32px",borderRadius:12,background:"#FAFAFA",border:"0.5px solid #E8E8E8"}}>
          <p style={{fontSize:14,color:"#444",lineHeight:1.8,maxWidth:520}}>
            The feed is full of generated content. Yours doesn't have to be. <strong style={{color:"#111",fontWeight:500}}>ContentHub gives creative teams the structure to plan, the data to decide, and the space to make something real.</strong> AI does what AI is actually good at. You do what only you can do.
          </p>
        </div>
      </div>
    ...
    <div style={{minHeight:"100vh",background:C.bg,fontFamily:"system-ui,sans-serif",display:"flex",alignItems:"center",justifyContent:"center",padding:24}}>
      <div style={{width:"min(500px,100%)",background:C.surface,borderRadius:20,border:`1px solid ${C.border}`,boxShadow:shMd,padding:"40px 36px",textAlign:"center"}}>
        ...
        <div style={{fontSize:14,color:C.muted,lineHeight:1.7,marginBottom:24,maxWidth:380,margin:"0 auto 24px"}}>
          Manage content pipelines for all your clients in one place. Every client gets their own board, targets, and AI that learns their voice.
        </div>
        <div style={{display:"flex",flexDirection:"column",gap:10,marginBottom:32,textAlign:"left",background:C.light,borderRadius:12,padding:"16px 18px"}}>
          {[
            ...
            ["✨","AI tailored per client","Scripts, shoot plans, and edit advice for each brand"],
          ].map(([e,t,d])=>(
      ...
      <div style={{width:"min(500px,100%)",background:C.surface,borderRadius:20,border:`1px solid ${C.border}`,boxShadow:shMd,padding:"40px 36px",textAlign:"center"}}>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:14,textAlign:"left",marginBottom:32}}>
          {[
            ...
            {n:"2",icon:"✨",title:"The AI learns each client separately",desc:"When you add a client, you'll answer a few quick questions about their brand. That's what makes the scripts actually sound like them."},
...
${JSON.stringify(selectedItems,null,2)}`}],
  ...
  if(phase==="start")return(
    <div style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",minHeight:500,padding:"48px 24px",textAlign:"center"}}>
      <div style={{fontSize:28,fontWeight:700,color:C.text,marginBottom:32,letterSpacing:-0.5}}>What campaign are you building?</div>
      <div style={{width:"min(580px,100%)",position:"relative",marginBottom:20}}>
        <textarea
          ...
          placeholder="Describe your campaign, brand, platform, and goal... (Enter to search)"
...
const CLIENT_QUESTIONS = [
  ...
  {key:"tone",        label:"How does their brand sound?",        hint:"Describe their voice — this shapes every AI script", placeholder:"Energetic and motivating, never pushy or corporate"},
];
      ...
      <div style={{width:"min(480px,100%)",background:C.surface,borderRadius:20,border:`1px solid ${C.border}`,boxShadow:shMd,padding:"36px 32px"}}>
        ...
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
          ...
          <div style={{display:"flex",gap:8,alignItems:"center"}}>
            ...
            <button onClick={next} disabled={!canNext} style={{padding:"10px 22px",background:canNext?C.text:C.border,color:canNext?"#FFF":C.muted,border:"none",borderRadius:8,fontSize:13,fontWeight:700,cursor:canNext?"pointer":"not-allowed"}}>
