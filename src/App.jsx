...
Use this structure:
EDITING ADVICE — [video title] ([platform] · [hook type])

☐ COLOR & MOOD
[2-3 specific color grading tips for this content type]

☐ PACING & CUTS
[2-3 specific pacing tips based on hook type and format]

☐ AUDIO
[2-3 audio tips — music, dialogue levels, sound effects]

☐ TEXT & CAPTIONS
[2-3 tips on text overlays, timing, font style]

☐ FIRST FRAME
[1 tip on the opening frame]

☐ FINISHING CHECKLIST
[3-4 final checks before posting]

Keep advice specific to THIS video and THIS brand — not generic editing tips.`;
                    ...
                    <div style={{padding:"11px 12px",flex:1,minWidth:0}}>
                      ...
                      {(stage.id==="idea"||stage.id==="production")&&(
                        v.script
                          ...
                          :<button onClick={()=>setAiCard(v)} style={{fontSize:10,padding:"4px 10px",background:"#EDE9FE",border:"1px solid #C4B5FD",borderRadius:20,cursor:"pointer",color:"#7C3AED",fontWeight:600}}>✨ Write script with AI</button>
                      )}
                      {stage.id==="production"&&(
                        v.shotList
                      ...
                      {stage.id==="editing"&&(
                        v.editAdvice
                          ?<button onClick={()=>setEditViewCard(v)} style={{fontSize:10,padding:"4px 10px",background:"#DCFCE7",border:"1px solid #BBF7D0",borderRadius:20,cursor:"pointer",color:C.green,fontWeight:600}}>✂️ Edit advice ready</button>
                          :<button onClick={()=>setEditCard(v)} style={{fontSize:10,padding:"4px 10px",background:"#DCFCE7",border:"1px solid #BBF7D0",borderRadius:20,cursor:"pointer",color:C.green,fontWeight:600}}>✨ Editing advice with AI</button>
                      )}
