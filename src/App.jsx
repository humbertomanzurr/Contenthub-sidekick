  ...
  return(
    <div>
      ...
      <Card style={{marginBottom:16}}>
        ...
        {totalGoal>0&&<><div style={{background:C.light,borderRadius:20,height:9,overflow:"hidden",marginBottom:6}}><div style={{width:`${pct}%`,height:"100%",background:pct===100?BRAND.green:BRAND.blue,borderRadius:20,transition:"width .4s"}}/></div><div style={{fontSize:11,color:C.muted}}>{clients.length} clients · {totalGoal-totalPub} videos remaining</div></>}
      </Card>
  ...
  return(
    <div>
      ...
      <Card style={{marginBottom:14}}>
        ...
        {goal>0&&<><div style={{background:C.light,borderRadius:20,height:8,overflow:"hidden",marginBottom:5}}><div style={{width:`${pct}%`,height:"100%",background:pct===100?BRAND.green:BRAND.blue,borderRadius:20,transition:"width .4s"}}/></div><div style={{fontSize:11,color:C.muted}}>{mVids.filter(v=>v.stage!=="published").length} in progress · {Math.max(0,goal-pub)} remaining</div></>}
      </Card>
