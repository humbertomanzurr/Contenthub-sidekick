...
function CreatorDashboard({videos,goals,month,onMonthChange,onSetGoal,onAddVideo,onMoveVideo,onMetrics,onDeleteVideo,userId,refGoal,refAdd,refStages,refPublished,refLock,tourStep,showAddFromTour,onAddFromTourDone,onTourNext,businessProfile,onSaveScript,onSaveShoot}){
...
function CreatorApp({user,profile,onLogout}){
  ...
  const saveShoot=useCallback(async(id,shootPlan)=>{
    ...
    await sbUpdate("creator_videos","id",id,{shoot_plan:shootPlan});
  },[]);
