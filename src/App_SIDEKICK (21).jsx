...
const BP_QUESTIONS = [
  ...
  },
  {
    ...
    placeholder: "A CrossFit gym in Monterrey helping competitive athletes reach their peak",
    type: "text",
  },
  {
    key: "audience",
    ...
    placeholder: "25–40 year olds who want to get fit but have never tried CrossFit",
    type: "text",
  },
  {
    key: "goal",
    ...
    placeholder: "Get people to sign up for a free trial class",
    type: "text",
  },
  {
    key: "tone",
    ...
    <div style={{minHeight:"100vh",background:C.bg,fontFamily:"system-ui,sans-serif",display:"flex",flexDirection:"column"}}>
      ...
      <div style={{background:C.surface,borderBottom:`1px solid ${C.border}`,padding:"0 20px",height:50,display:"flex",alignItems:"center",justifyContent:"space-between",flexShrink:0,boxShadow:sh}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:9}}>
          ...
          <button onClick={()=>setShowProfileModal(true)} title="Business profile" style={{background:"none",border:`1px solid ${C.border}`,borderRadius:6,color:C.muted,cursor:"pointer",fontSize:11,padding:"3px 8px",display:"flex",alignItems:"center",gap:4}}>
            🏢 Profile
          </button>
